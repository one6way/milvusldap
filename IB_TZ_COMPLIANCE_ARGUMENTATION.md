...
Отличие от буквальной формулировки ТЗ («модификация исходного кода Milvus») — **целенаправленное архитектурное решение**: перенос контролей ИБ на корпоративный IdM и периметр, что соответствует лучшим практикам и снижает операционный риск в air-gap контуре.
